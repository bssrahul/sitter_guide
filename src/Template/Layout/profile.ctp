...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
  <?php 
		echo $this->Html->script([/*'Front/owl.carousel.min.js',*/'Front/bootstrap.min.js','Front/jquery.flexslider.js'/*,'Front/dist/js/drawer.min.js','Front/js2/classie.js'*/,'Front/jquery.validate.js','Front/custom.js']); 
	?>
