                   ...
                   <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<?= $this->element('adminElements/validations'); ?>
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="slider_type">Slider Type<span class="required">*</span>
										</label>
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="media">Media
										</label>
										 <div class="col-md-6 col-sm-6 col-xs-12">
										   <?php 
