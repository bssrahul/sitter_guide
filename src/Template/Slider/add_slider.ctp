<div class="">
                   <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						    <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo $this->requestAction('users/get-translate/'.base64_encode('Add Slider')); ?><small></small></h2>
							...
							<?= $this->element('adminElements/validations'); ?>
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="slider_type"><?php echo $this->requestAction('users/get-translate/'.base64_encode('Slider Type')); ?><span class="required">*</span>
										</label>
