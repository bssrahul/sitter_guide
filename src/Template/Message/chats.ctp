...
echo $this->Html->script(['Front/messages.js']); ?>
                                ...
                                <div class="top-message-strip">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 ">
                                            <!--<div class="row">
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 "> <p class="head-inbox"><span> <i class="fa fa-inbox"></i></span> Inbox</p></div>
  ...
  <div class="form-group">
    ...
    <select  class="form-control">
      ...
      <div class="col-xs-12 col-sm-2 col-md-4 col-lg-4 "> <p class="head-inbox"><span> <i class="fa fa-inbox"></i></span> Message</p></div>
