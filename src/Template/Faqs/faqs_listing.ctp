							...
							<tr class="<?php echo $class; ?>">
								...
								<td class=" last">
								  ...
								  <a title="Edit" href="<?php echo HTTP_ROOT."Faqs/edit-faqs/".base64_encode(convert_uuencode($faq_info->id));?>"><span><i class="fa fa-pencil-square"></i></span></a>
								   ...
								   <a title="Delete" href="<?php echo HTTP_ROOT."users/delete-row/".'Faqs'.'/'.base64_encode(convert_uuencode($faq_info->id));?>" onclick="if(!confirm('Are you sure to delete this User?')){return false;}" ><span class="fa fa-fw fa-trash-o"></span></a>
								</td>
							</tr>
							<?php $i++;
							} 
