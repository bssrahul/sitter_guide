										...
										<div id="menu2"  class="tab-pane fade in active">
											<?php foreach($guest as $guestData) { $count=0;?>
												<div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
													<h5 class="pt22"><span><?php if(!empty($guestData)){echo $guestData['title'][0];}?></span></h5>
															<ul class=" list-unstyled tab-text">
																<?php foreach($guestData as $que_value) { $count++; 
																	if($count <  5){?>
																	<li><?php echo isset($que_value->question)?$que_value->question:'';?></li>
																
																<?php } } ?>
														
												
												<li class="pad-bottom10"><a href="<?php echo HTTP_ROOT."Pages/help-listing/".base64_encode(convert_uuencode($que_value->category_id))."/".base64_encode(convert_uuencode(0));?>"><b>See all articles</b></a></li> 
												</ul>
					...
					<?php  if(empty($sitter)){?><div class="col-md-3 col-md-offset-5"><h4><?php echo "Record Not Found";?><h4></div> <?php	 }
										...
										<div id="menu3" class="tab-pane fade in active">
											<?php foreach($sitter as $sitterData) { $count=0;?>
												...
												<li class="pad-bottom10"><a href="<?php echo HTTP_ROOT."Pages/help-listing/".base64_encode(convert_uuencode($que_value->category_id));?>"><b>See all articles</b></li> 
												</ul>
