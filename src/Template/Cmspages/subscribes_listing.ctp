...
<div class="">
	...
	<div class="row">
	    <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2> Subscribers Listing</h2><h2 style="float:right"><a style="float:right" href="<?php echo HTTP_ROOT.'cmspages/send-news-letter'; ?>"><button class="btn btn-success addUser" type="button">Send News Letter</button></a></h2>
				...
				<div class="x_content table-responsive">
						...
						<thead>
							<tr class="headings">
								...
								<th class="text-center column-title">Email</th>
						 ...
						 ?>
							...
							<?php $i++;
								...
								<tr class="even pointer">
									<td class="noRecords" colspan="7" style=" text-align:center;"> <?php echo __('No records found'); ?></td>
								</tr>
							<?php } ?>
						</tbody>
					</table>
