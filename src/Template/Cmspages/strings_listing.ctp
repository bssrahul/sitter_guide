						 ...
						 ?>
							...
							<tr class="<?php echo $class; ?>">
								...
								<td class=" last">
								 ...
								 <a title="Delete" href="<?php echo HTTP_ROOT."users/delete-row/".'StaticStrings'.'/'.base64_encode(convert_uuencode($string_info->id));?>" onclick="if(!confirm('Are you sure to delete this User?')){return false;}" ><span class="fa fa-fw fa-trash-o"></span></a>
