										...
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Image
										 ...
										 <div class="col-md-6 col-sm-6 col-xs-12">
										   <?php 
											...
											?>
											<img alt="Image not found" style="margin:5px" height="100px"; width="100px"; src="<?php echo HTTP_ROOT.'img/uploads/'.($blogInfo->image != ''?$blogInfo->image:'prof_photo.png'); ?>"/>
										</div>
									</div>
