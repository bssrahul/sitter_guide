<div class="">
                   <div class="row">
					 ...
					 <div class="col-md-12 col-sm-12 col-xs-12">
						    <div class="x_panel">
                                <div class="x_title">
                                    <h2>Edit News Updates<small></small></h2>
										...
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Image
										 ...
										 <div class="col-md-6 col-sm-6 col-xs-12">
										   <?php 
											...
											?>
											<img alt="Image not found" style="margin:5px" height="100px"; width="100px"; src="<?php  echo HTTP_ROOT.'img/uploads/'.($work_info->image != ''?$work_info->image:'prof_photo.png'); ?>"/> 	
										</div>
									</div>
