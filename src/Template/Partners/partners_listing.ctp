...
<div class="">
	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2><?php echo $this->requestAction('users/get-translate/'.base64_encode('Partners Listing')); ?></h2><h2 style="float:right"> 
						<?php 
					$languageSession = $this->request->session();
					if($languageSession->read('requestedLanguage')=='en'){ ?>	
						<a style="float:right" href="<?php echo HTTP_ROOT.'partners/add-partner'; ?>"><button class="btn btn-success addUser" type="button"><?php echo $this->requestAction('users/get-translate/'.base64_encode('Add Partner')); ?></button></a>
						<?php } ?>
						</h2>
				...
				<div class="x_content table-responsive">
						...
						<thead>
							<tr class="headings">
								...
								<th class="column-title"><?php echo $this->requestAction('users/get-translate/'.base64_encode('Short Description')); ?></th>
								<th class="column-title"><?php echo $this->requestAction('users/get-translate/'.base64_encode('Long Description')); ?></th>
                        ...
                        <tbody>
						 ...
						 ?>
							...
							<tr class="<?php echo $class; ?>">
								...
								<td class=" last">
								   <a title="<?php echo($partner_info->status == 0?'Activate status':'Deactivate Status') ?>" href="<?php echo HTTP_ROOT."users/update-status-row/".'Partners'.'/'.base64_encode(convert_uuencode($partner_info->id)).'/'.$target[$partner_info->status];?>" ><span class="fa fa-fw fa-check-square<?php echo($partner_info->status ==0?'-o':'') ?>"></span></a>
