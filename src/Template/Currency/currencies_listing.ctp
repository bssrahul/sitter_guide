						 ...
						 ?>
							...
							<tr class="<?php echo $class; ?>">
								...
								<td class=" last">
								  ...
								  <!-- <a title="Delete" href="<?php echo HTTP_ROOT."users/delete-row/".'Currencies'.'/'.base64_encode(convert_uuencode($currency_info->id));?>" onclick="if(!confirm('Are you sure to delete this User?')){return false;}" ><span class="fa fa-fw fa-trash-o"></span></a>-->
								</td>
							</tr>
							<?php $i++;
							}
