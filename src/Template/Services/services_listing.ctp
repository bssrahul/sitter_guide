...
<div class="">
	...
	<div class="row">
	    <div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
                   <h2> <?php echo $this->requestAction('users/get-translate/'.base64_encode('Manage Services')); ?></h2>
				...
				<div class="x_content table-responsive">
						...
						<thead>
							<tr class="headings">
								...
								<th style="text-align:center" class="column-title"><?php echo $this->requestAction('users/get-translate/'.base64_encode('Image')); ?></th>
								...
								<th class="column-title" style="width:300px"><?php echo $this->requestAction('users/get-translate/'.base64_encode('Description')); ?></th> 
                        ...
                        <tbody>
						 ...
						 ?>
							...
							<tr class="<?php echo $class; ?>">
								...
								?></td>
								 <td><?php echo $services_info->status == 1?'Active':'Blocked';	?></td>
								<?php $target = ['0'=>'1','1'=>'0'];?>
								<td class=" last">
								  <a title="<?php echo($services_info->status == 0?'Activate status':'Deactivate Status') ?>" href="<?php echo HTTP_ROOT."users/update-status-row/".'Services'.'/'.base64_encode(convert_uuencode($services_info->id)).'/'.$target[$services_info->status];?>" ><span class="fa fa-fw fa-check-square<?php echo($services_info->status ==0?'-o':'') ?>"></span></a>
								
								  <a title="Edit" href="<?php echo HTTP_ROOT."services/edit-services/".base64_encode(convert_uuencode($services_info->id));?>"><span><i class="fa fa-pencil-square"></i></span></a>
								  
								   <a title="Delete" href="<?php echo HTTP_ROOT."users/delete-row/".'Services'.'/'.base64_encode(convert_uuencode($services_info->id));?>" onclick="if(!confirm('Are you sure to delete this record?')){return false;}" ><span class="fa fa-fw fa-trash-o"></span></a>
								</td>
							</tr>
							<?php $i++;
							} 
