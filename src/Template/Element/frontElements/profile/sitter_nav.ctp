 ...
 <ul class="nav nav-pills">
   ...
   // print_r($action);
    ...
    ?>
      ...
      <li class="<?php echo @$activeSitt; ?> sitt"><a  href="<?php echo HTTP_ROOT."dashboard/about-sitter"; ?>"><img src="<?php echo HTTP_ROOT; ?>img/ic3.png">Sitter</a></li>
      <li class="<?php echo @$activeProa; ?> proa"><a  href="<?php echo HTTP_ROOT."dashboard/professional-accreditations"; ?>"><img src="<?php echo HTTP_ROOT; ?>img/ic4.png">Professional Accreditations</a></li>
