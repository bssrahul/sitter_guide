<!-- Search mobile menu-->
<div class="modal fade search_modal" id="myModal_search" role="dialog">
  <div class="modal-dialog serch_bolie_mar"> 
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header mobile_header">
      ...
      <div class="modal-body">
        <div class="serach_btn-sm_mobile">
          ...
          <div class="row">
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6 pad-pop-right">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="room_icon">
                <ul>
                  ...
                  <li> <img src="<?php echo HTTP_ROOT; ?>img/shared_room_1.png" alt="" class="img-responsive">
                    <p>Shared Room </p>
                  </li>
                </ul>
              </div>
