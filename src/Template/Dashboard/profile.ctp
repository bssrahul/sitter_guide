              ...
              <div id="menu11" class="tab-pane fade tab-comm">
                  ...
                  <div class="row">
                    <div class="form-group col-lg-4">
                      ...
                      <?php echo $this->Form->input('SitterHouses.property_type',[
                        'templates' => ['inputContainer' => '{{content}}'],
                        'label' => false,
                        'type'=>'select',
                    ...
                    <div class="form-group col-lg-4 text-italic">
                      ...
                      <!--<select class="form-control" id="sel1">
                          ...
                          <?php echo $this->Form->input('SitterHouses.outdoor_area',[
                        'templates' => ['inputContainer' => '{{content}}'],
                        'label' => false,
                        'type'=>'select',
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <?php echo $this->Form->input('SitterHouses.outdoor_area_size',[
                        'templates' => ['inputContainer' => '{{content}}'],
                        'label' => false,
                        'type'=>'select',
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <?php echo $this->Form->input('SitterHouses.outing_allow_multiple',[
                        'templates' => ['inputContainer' => '{{content}}'],
                        'label' => false,
                        'type'=>'select',
                    ...
                    <div class="form-group col-lg-4">
                     ...
                     <!-- <input type="text" class="form-control mzero" id="" placeholder="New Password">-->
                      <?php echo $this->Form->input('SitterHouses.cancellation_policy',[
                        'templates' => ['inputContainer' => '{{content}}'],
                        'label' => false,
                        'type'=>'select',
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <!--<input type="text" class="form-control mzero" id="" placeholder="New Password">-->
                       <?php echo $this->Form->input('SitterHouses.breaks_provided_every',[
                        'templates' => ['inputContainer' => '{{content}}'],
                        'label' => false,
                        'type'=>'select',
